...
const ConnectWithMe = () => {
    return (
        <section  id="connect" className='min-h-screen flex-col gap-12 flex items-center justify-center'>
            <h2 className="text-white text-4xl font-extrabold">Connect with me</h2>
